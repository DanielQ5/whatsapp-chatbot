...
@EnableJpaRepositories(
        basePackages = "com.chatbot.whatsapp_chatbot.insurance.chatanalytics.repository",  // Where is InteractionLogRepository?
...
public class ChatAnalyticsDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean chatAnalyticsEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.chatbot.whatsapp_chatbot.insurance.chatanalytics.entity")  // Where is InteractionLog entity?
